...
<template>
  <main class="flex h-screen overflow-y-hidden">
    <nav
      class="w-[300px] h-full p-4 border-r-stone-200 border-r flex flex-col justify-between"
    >
      <div>
        <header class="my-12 flex space-x-4 items-center">
          <svg
          ...
          <ul class="grid gap-2">
            ...
            >
              ...
              >
                ...
                <span>{{ route.meta?.navigationName }}</span>
              </Button>
            </RouterLink>
          </ul>
        </section>
      ...
      <div class="border bg-card rounded-lg text-sm p-2">
        <div
          class="flex items-center space-x-2 mb-4 border-b border-border pb-4 px-3 pt-2"
        >
            ...
            <img
              ...
              :src="
                currentUser?.photoURL
                  ? currentUser?.photoURL
                  : `https://api.dicebear.com/9.x/thumbs/svg?seed=${currentUser?.uid}`
              "
              alt=""
            />
          </div>
        ...
        <div>
          ...
          <Button
            ...
            variant="ghost"
            size="sm"
            class="w-full justify-start hover:bg-destructive hover:text-white space-x-4"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
